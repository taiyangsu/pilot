...
```bash
# 下载并运行脚本
bash <(curl -s -L https://github.com/taiyangsu/openpilot/main/op_install.sh)
```
...
curl -o /sdcard/op_install.sh -L [https://github.com/taiyangsu/openpilot/main/op_install.sh]
